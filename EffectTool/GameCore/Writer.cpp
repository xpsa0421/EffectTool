...
{
	HRESULT hr = _d2dRT->CreateSolidColorBrush(_textColor, &_colorBrush);
	return hr;
}
...
void Writer::SetDefaultColor(D2D1_COLOR_F color)
{
	_textColor = color;
}

bool Writer::Draw(float x, float y, W_STR text)
{
	return Draw(x, y, text, _textColor);
}
